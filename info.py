...
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/Trusted_Sellers_Of_Pd/5') # How to open tutorial link for verification
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002851899064')) #Log channel id ( make sure bot is admin )
